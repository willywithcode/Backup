...
@section('content')
    <img src="{{ asset('assets/logo-logo1.png') }}" alt="Logo Background"
        style="width: 30%; position: fixed; right: 0; bottom: 0; z-index: 1;">
    ...
    <section class="about-us py-16">
        <div class="container-fluid p-0">
            <div class="about-content flex flex-col md:flex-row items-center">
                <!-- Image moved to left -->
                <div class="about-image w-full md:w-2/5 mb-8 md:mb-0 relative my-20" data-aos="fade-right"
                    data-aos-duration="1000">
                    <img src="{{ asset('assets/home/woman-with-headset-having-video-call-laptop 1.png') }}"
                        alt="Behind Office Team" class="w-full h-auto">
                    <!-- Project count box positioned below the image and extending beyond right edge -->
                    <div
                        class="project-count absolute -bottom-12 -right-10 bg-[#071B35] text-white py-4 px-6 rounded-md w-80 h-15 shadow-lg">
                ...
                <div class="about-image w-full md:w-1/10 mb-8 md:mb-0 relative" data-aos="fade-right"
                    data-aos-duration="1000">
                ...
                <div class="about-text w-full md:w-1/2 md:pr-40" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div class="text-gray-700 space-y-8">
                        <p>Behind Office là đơn vị chuyên cung cấp dịch vụ trợ lý chuyên nghiệp, hỗ trợ doanh nghiệp và cá
                            nhân trong việc quản lý công việc, tối ưu hóa quy trình vận hành và nâng cao hiệu suất làm việc.
                            Với sứ mệnh giúp khách hàng giảm tải áp lực hành chính, chúng tôi mang đến đội ngũ trợ lý giàu
                            kinh nghiệm, linh hoạt và tận tâm, sẵn sàng đồng hành trong mọi khía cạnh của công việc</p>
                        <p>Với quy trình làm việc chuyên nghiệp, bảo mật thông tin tuyệt đối và giải pháp linh hoạt theo
                            từng nhu cầu, Behind Office cam kết giúp khách hàng tối ưu thời gian, tập trung vào các mục tiêu
                            quan trọng và phát triển kinh doanh bền vững. Chúng tôi không chỉ là trợ lý – mà còn là người
                            đồng hành đáng tin cậy trên hành trình thành công của bạn!</p>
                        <p>Với quy trình làm việc chuyên nghiệp, bảo mật thông tin tuyệt đối và giải pháp linh hoạt theo
                            từng nhu cầu, Behind Office cam kết giúp khách hàng tối ưu thời gian, tập trung vào các mục tiêu
                            quan trọng và phát triển kinh doanh bền vững. Chúng tôi không chỉ là trợ lý – mà còn là người
                            đồng hành đáng tin cậy trên hành trình thành công của bạn!</p>
        ...
        <div class="container mx-auto px-4">
            <div class="vision-content text-center mb-16 md:pr-10 md:pl-10">
                ...
                <p class="text-gray-700 w-full mx-auto text-center mb-10">
                    Tại Behind Office, chúng tôi hiểu rằng thời gian là tài sản quý giá nhất của bạn. Vì vậy, chúng tôi cung
                    cấp dịch vụ trợ lý chuyên nghiệp giúp doanh nghiệp và cá nhân tối ưu hóa công việc, giảm tải áp lực hành
                    chính và tập trung vào các mục tiêu quan trọng.
                </p>
            </div>
            <div class="vision-image relative" data-aos="fade-up" data-aos-duration="1000">
                <img src="{{ asset('assets/about/image (1).png') }}" alt="Vision"
    ...
    <section class="mission-section py-16" style = "z-index: 10">
        <div class="container mx-auto px-4">
            ...
            <div class="mission-image" data-aos="fade-up" data-aos-duration="1000">
                <img src="{{ asset('assets/about/pexels-fauxels-3183150 1.png') }}" alt="Mission"
            ...
            <div class="mission-content text-center md:pr-10 md:pl-10 mt-10" style="margin-top: 50px;">
                <p class="text-gray-700 w-full mx-auto text-center">
                    Behind Office cam kết mang đến dịch vụ trợ lý chuyên nghiệp, giúp cá nhân và doanh nghiệp tối ưu hóa
                    công việc, tiết kiệm thời gian và nâng cao hiệu suất. Chúng tôi không chỉ hỗ trợ, mà còn đồng hành cùng
                    khách hàng trong mọi thử thách, đảm bảo quy trình làm việc hiệu quả, bảo mật và linh hoạt nhất.
                </p>
            </div>
        </div>
    </section>
                    ...
                    <form class="consultation-form-fields">
                        <div class="form-row grid grid-cols-2 gap-4 mb-4">
                            <div class="form-group">
                                <input type="text" placeholder="Họ và tên"
                                    class="form-control bg-white/80 text-black placeholder-gray-600 rounded px-4 py-2 w-full">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row mb-4">
                            <textarea rows="4" placeholder="Lời nhắn..."
                                class="form-control bg-white/80 text-black placeholder-gray-600 rounded px-4 py-2 w-full"></textarea>
                        </div>

                        <div class="form-row">
                            <button type="submit"
                                class="submit-btn bg-[#2990D0] hover:bg-blue-700 transition px-6 py-3 rounded-lg text-white font-semibold">GỬI
                                YÊU CẦU</button>
                        </div>
                    </form>
                </div>
