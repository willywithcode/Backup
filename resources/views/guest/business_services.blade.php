...
@section('content')
    ...
    <section class="container our-services mx-auto pb-24 px-4 md:px-8 mt-12 md:mt-20"
                    ...
                    <div class="services-slider overflow-x-auto">
                        <div class="services-track flex space-x-6" style="min-width: max-content;">
                            ...
                            <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                                <div class="service-card-frame">
                                    <div class="service-image-wrapper">
                                        <img src="{{ asset('assets/home/charming-ethnic-businesswoman-using-laptop 1.png') }}"
                                            alt="Trợ lý hành chính giấy tờ" class="service-image">
                                        <div class="service-overlay">
                                            <div class="service-content">
                                                <p class="service-description">Giúp doanh nghiệp tiết kiệm thời gian và tối
                                                    ưu quy trình làm việc. Chúng tôi hỗ trợ soạn thảo, xử lý, lưu trữ và
                                                    quản lý hồ sơ...</p>
                                                <a href="{{ route('services.detail', ['slug' => 'tro-ly-hanh-chinh']) }}"
                            ...
                            <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                                <div class="service-card-frame">
                                    <div class="service-image-wrapper">
                                        <img src="{{ asset('assets/home/side-view-smiley-business-woman 1.png') }}"
                                            alt="Trợ lý sắp xếp công việc" class="service-image">
                                        <div class="service-overlay">
                                            <div class="service-content">
                                                <p class="service-description">Chúng tôi giúp bạn tổ chức lịch trình, quản
                                                    lý cuộc họp, và điều phối công việc hiệu quả để tối ưu hóa thời gian và
                                                    năng suất.</p>
                                                <a href="{{ route('services.detail', ['slug' => 'tro-ly-ke-toan']) }}"
                                                    class="service-btn">Xem thêm</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="service-card" data-aos="fade-up" data-aos-delay="300">
                                <div class="service-card-frame">
                                    <div class="service-image-wrapper">
                                        <img src="{{ asset('assets/home/image-young-asian-woman-company-worker-glasses-smiling-holding-digital-tablet-standing-white-background 1.png') }}"
                                            alt="Cung cấp nhân lực" class="service-image">
                                        <div class="service-overlay">
                                            <div class="service-content">
                                                <p class="service-description">Chúng tôi cung cấp dịch vụ tìm kiếm và tuyển
                                                    dụng nhân sự chất lượng cao, giúp doanh nghiệp tiết kiệm thời gian và
                                                    chi phí.</p>
                                                <a href="{{ route('services.detail', ['slug' => 'giai-quyet-cong-viec']) }}"
                                                    class="service-btn">Xem thêm</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="service-card" data-aos="fade-up" data-aos-delay="400">
                                <div class="service-card-frame">
                                    <div class="service-image-wrapper">
                                        <img src="{{ asset('assets/home/young-business-lady 1.png') }}"
                                            alt="Trợ lý hành chính văn" class="service-image">
                                        <div class="service-overlay">
                                            <div class="service-content">
                                                <p class="service-description">Chúng tôi hỗ trợ soạn thảo, hiệu đính và quản
                                                    lý tài liệu, văn bản để đảm bảo tính chuyên nghiệp và hiệu quả.</p>
                                                <a href="{{ route('services.detail', ['slug' => 'tro-ly-van-phong']) }}"
                                                    class="service-btn">Xem thêm</a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="about-us py-16 bg-white relative overflow-hidden">
                <div class="container mx-auto">
                    <div class="about-content grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-24">
                        <div class="about-image relative" data-aos="fade-right"
                        ...
                        <div class="about-text" data-aos="fade-left"
                            ...
                            <div class="text-gray-700 space-y-4 text-justify md:pr-10">
                                <p>Behind Office là đơn vị chuyên cung cấp dịch vụ trợ lý chuyên nghiệp, hỗ trợ doanh
                                ...
                                <p>Với quy trình làm việc chuyên nghiệp, bảo mật thông tin tuyệt đối và giải pháp linh
                                ...
                                <p>Chúng tôi không chỉ là trợ lý – mà còn là người đồng hành đáng tin cậy trên hành
                                    trình thành công của bạn!</p>
                            </div>
                            <div class="about-action mt-8 flex justify-center md:justify-start">
                                <a href="{{ route('contact') }}"
                                    class="bg-[#2EA7E0] text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">Liên
                                    hệ</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="why-choose-section py-16 relative"
        style="background-image: url('{{ asset('assets/home/Why choice us.png') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="container mx-auto">
