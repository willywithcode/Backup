...
@section('content')
    <div class="service-detail-page bo-service-detail-wrapper" style = "z-index: 10">
        ...
        <!-- Hero Section -->
        <div class="relative w-screen h-[600px] hero_section">
        ...
        <div class="bo-service-detail-content container mx-auto px-4 py-16">
            <div class="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div class="bo-service-detail-image w-full md:w-1/2 relative">
                    <img src="{{ asset($post->thumbnail ?? 'assets/default-service.png') }}" alt="{{ $post->title }}"
                ...
                <div class="bo-service-detail-text w-full md:w-1/2">
                    ...
                    <div class="text-gray-700 leading-relaxed mb-6 prose max-w-none text-justify">
                        {!! $post->content !!}
                    </div>
                    ...
                    <div class="hex-row">
                        ...
                        <div class="hex-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                            <div class="hex-content">
                                ...
                                <div class="hex-overlay">
                                    <h3>Hiệu quả</h3>
                                    <p>Behind Office cam kết kết quả tối ưu, tiến độ công việc nhanh chóng, tăng hiệu quả
                                        giảm
                                        chi phí.</p>
                                </div>
                            </div>
                        ...
                        <div class="hex-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                            <div class="hex-content">
                                ...
                                <div class="hex-overlay">
                                    <h3>Uy tín</h3>
                                    <p>Behind Office cam kết bảo mật hàng đầu, với đội ngũ chuyên môn đã làm việc với nhiều
                                        đối
                    ...
                    <div class="hex-row hex-row-offset"
                        ...
                        <div class="hex-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                            <div class="hex-content">
                                ...
                                <div class="hex-overlay">
                                    <h3>Tiện lợi</h3>
                                    <p>Đối tác chuyên nghiệp, phản hồi nhanh chóng, đem lại trải nghiệm dịch vụ tốt nhất.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="our-services mt-12" style="background:none;">
            <div class="container mx-auto px-4">
                                ...
                                <div class="service-card" data-aos="fade-up">
                                    <div class="service-card-frame">
                                        <div class="service-image-wrapper">
                                            <img src="{{ asset($item->thumbnail ?? 'assets/default-service.png') }}"
                                                alt="{{ $item->title }}" class="service-image">
